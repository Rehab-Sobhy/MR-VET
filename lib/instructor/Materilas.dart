...
class MaterialsScreen extends StatelessWidget {
  ...
  // Get the download path with caching support
  Future<String> _getDownloadPath(String fileName) async {
    final dir =
        await getApplicationDocumentsDirectory(); // Changed to persistent storage
                            ...
                            onPressed: () {
                              showDialog(
                                ...
                                builder: (context) => AlertDialog(
                                  title: Text('materials.delete_title'.tr()),
                                  content: Text(
