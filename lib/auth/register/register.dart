...
class RegisterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => RegisterCubit(),
      child: _RegisterScreenBody(role: role),
    );
  }
}
...
class _RegisterScreenBody extends StatefulWidget {
  ...
  const _RegisterScreenBody({Key? key, required this.role}) : super(key: key);
              ...
              builder: (context, state) {
                return Column(
                  ...
                  children: [
                    ...
                    _buildRoleChip(),
                    const Gap(30),
                    _buildTextField('full_name'.tr(), 'enter_full_name'.tr(),
                        _nameController, Icons.person_outline),
                    const Gap(20),
                    _buildTextField('email_address'.tr(), 'enter_email'.tr(),
                        _emailController, Icons.email_outlined,
                        type: TextInputType.emailAddress),
                    const Gap(20),
                    _buildTextField('password'.tr(), 'enter_password'.tr(),
            ...
            children: [
              file != null
                  ...
                  : Icon(Icons.cloud_upload_outlined,
                      size: 40, color: primaryColor.withOpacity(0.5)),
              const Gap(8),
              Text(label,
                  style: TextStyle(
